...
\item \textbf{Show Manager}
	\begin{enumerate}
		...
		\item Create Account for SalesPerson and Clerk: The SM is able to create new account for authorised salespersons and accounts clerk.
...
\item \textbf{Accounts Clerk}
	\begin{enumerate}
		...
		\item Generate Balance Sheet: AC can generate a balance sheet for every show and an up-to-date balance sheet for every year.
		
	\end{enumerate}

\item \textbf{Sales Person}
	\begin{enumerate}
		\item  Authorise Ticket Booking: SP will be able to authorise tickets for a customer and make a sale for the show.
	\end{enumerate}

\item \textbf{Customer}
	\begin{enumerate}
		\item Book Tickets: The customer will be able to book tickets for themselves by paying the ticket price to an authorised SP.
...
\begin{itemize}
	\item Computers are available to all types of users and printers are provided to the SP for ticket printing.
