...
\item Show Manager
	\begin{enumerate}
		\item Add New Show: The SM can add a new show with a date,timings based on the availability of the auditorium. Fixing a particular number of shows on a date and fixing the number and price of the balcony and ordinary seats for a particular are exculusive rights of SM.Offering seats as complimentary gifts to the students' society and VIPs are also handled by the SM.
		...
		\item Check Balance Sheet: The SM can access the balance sheet for the auditorium.
	\end{enumerate}
\item Accounts Clerk
	\begin{enumerate}
		\item Add New Show: The SM 
